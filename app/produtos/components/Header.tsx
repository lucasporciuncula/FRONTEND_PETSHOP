      ...
      <div className="w-full bg-white border-t border-gray-100">
        <nav className="max-w-7xl mx-auto px-4 py-3 flex justify-between items-center">
          <div className="relative">
            <select className="appearance-none bg-[#664533] text-white text-xs font-medium uppercase tracking-wider py-2.5 pl-4 pr-10 rounded cursor-pointer outline-none">
          ...
          <div className="flex items-center gap-4 text-gray-700">
            <button className="hover:text-[#664533] transition-colors p-1">
