...
export default function Banner() {
  return (
    <section className="bg-[#F9F3EC] py-12 md:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 grid md:grid-cols-12 gap-8 items-center">
        ...
        <div className="md:col-span-7 space-y-6 text-center md:text-left order-1 md:order-2">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-7xl font-normal text-gray-900 leading-tight">
            O melhor destino para os <span className="text-[#DEAD6F] block sm:inline">seus pets</span>
          </h1>
          <div className="pt-4">
            <Link 
              href="#" 
              className="inline-flex items-center gap-2 border-2 border-gray-900 px-8 py-3.5 rounded text-sm uppercase font-semibold text-gray-900 hover:bg-gray-900 hover:text-white transition-all group"
            >
              Comprar Agora
            </Link>
          </div>
