...
export default function VisitingHours() {
  ...
  return (
    <section className="w-full bg-[#4a2f20] my-16 py-16 text-white">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-6">
          <h1 className="text-3xl font-bold tracking-tight border-b border-white/20 pb-4">Horário de atendimento</h1>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 py-2 border-b border-white/10">
              ...
              <span className="col-span-2 opacity-95">Av principal, Santa Cruz do Sul, BR</span>
            </div>
            <div className="grid grid-cols-3 py-2 border-b border-white/10">
            ...
            <div className="grid grid-cols-3 py-2 border-b border-white/10">
              ...
              <div className="col-span-2 space-y-1 opacity-95">
                <p>+51 987 345 6789</p>
                <p className="text-sm opacity-75">Pet-shop@gmail.com</p>
              </div>
            </div>
          </div>
        </div>
