...
export default function Topbar() {
  return (
    <div className="w-full bg-gray-100 text-gray-600 text-sm hidden lg:block border-b border-gray-200">
      <div className="max-w-9xl mx-auto px-6 h-12 flex justify-between items-center">
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2">
            <MapPin className="w-4 h-4 text-[#4a2f20]" />
            <span>Avenida principal, Santa Cruz do Sul, BR</span>
          </div>
          <div className="flex items-center gap-2">
            <Clock className="w-4 h-4 text-[#4a2f20]" />
            <span>7:30 AM - 21:30 PM</span>
          </div>
        </div>
        
        <div className="flex items-center gap-4 text-gray-500">
          <a href="#" className="hover:text-[#4a2f20] transition-colors">
